...
c = pd.read_csv("results_manual_c.csv")
ocaml = pd.read_csv("results_manual_ocaml.csv")
...
plt.title("AES-128 Encryption Time")
plt.legend()
plt.grid(True)
...
plt.title("AES-128 Decryption Time")
plt.legend()
plt.grid(True)
...
plt.title("AES-128 Encryption Throughput")
plt.legend()
plt.grid(True)
...
plt.xlabel("Input Size (MB)")
plt.ylabel("Throughput (MB/s)")
plt.title("AES-128 Decryption Throughput")
plt.legend()
plt.grid(True)
