...
LABELS = {
    "c":      "C (AES-NI inline)",
    "ocaml":  "OCaml + C bindings",
    "oxcaml": "OxCaml SIMD (partial)",
}
...
plt.title("AES-NI Encryption Time: C vs OCaml C-bindings vs OxCaml SIMD")
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.title("AES-NI Decryption Time: C vs OCaml C-bindings vs OxCaml SIMD")
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.title("AES-NI Encryption Throughput: C vs OCaml C-bindings vs OxCaml SIMD")
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.xlabel("Input Size (MB)")
plt.ylabel("Throughput (MB/s)")
plt.title("AES-NI Decryption Throughput: C vs OCaml C-bindings vs OxCaml SIMD")
plt.legend()
plt.grid(True)
plt.tight_layout()
