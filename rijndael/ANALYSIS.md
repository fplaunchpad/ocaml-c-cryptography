...
![Encryption Time Comparison](benchmarks/results_all_comparison/encryption_time_comparison.png)
...
![Decryption Time Comparison](benchmarks/results_all_comparison/decryption_time_comparison.png)
...
![Encryption Throughput Comparison](benchmarks/results_all_comparison/encryption_speed_comparison.png)
...
![Decryption Throughput Comparison](benchmarks/results_all_comparison/decryption_speed_comparison.png)
...
![Encryption Optimisation Journey](benchmarks/results_all_comparison/optimization_journey_encryption.png)
...
![Decryption Optimisation Journey](benchmarks/results_all_comparison/optimization_journey_decryption.png)
...
*Graphs generated from benchmark data in `benchmarks/results_final_opt/c_results.csv`, `benchmarks/results/results_rijndael_ocaml.csv`, `benchmarks/results_opt/results_rijndael_ocaml_opt.csv`, and `benchmarks/results_final_opt/ocaml_results.csv`.*
