...
plt.plot(sizes, c["EncryptTime"],     marker="o", label="C")
plt.plot(sizes, ocaml["EncryptTime"], marker="o", label="OCaml (optimised)")
...
# 2. Decryption time
plt.figure(figsize=(8, 5))
plt.plot(sizes, c["DecryptTime"],     marker="o", label="C")
plt.plot(sizes, ocaml["DecryptTime"], marker="o", label="OCaml (optimised)")
plt.xlabel("Input Size (MB)")
...
plt.figure(figsize=(8, 5))
plt.plot(sizes, c["EncryptSpeed"],     marker="o", label="C")
plt.plot(sizes, ocaml["EncryptSpeed"], marker="o", label="OCaml (optimised)")
plt.xlabel("Input Size (MB)")
...
plt.figure(figsize=(8, 5))
plt.plot(sizes, c["DecryptSpeed"],     marker="o", label="C")
plt.plot(sizes, ocaml["DecryptSpeed"], marker="o", label="OCaml (optimised)")
plt.xlabel("Input Size (MB)")
plt.ylabel("Throughput (MB/s)")
